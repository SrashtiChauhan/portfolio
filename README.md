...
- Interactive cursor heart spark effect
...
```bash
git clone https://github.com/revatikadam0607/portfolio.git
```
...
Run locally using Live Server in VS Code  
...
LeetCode: https://leetcode.com/u/Revati0607/
